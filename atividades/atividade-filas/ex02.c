...
/*
Exercício 2 — Consulta do Primeiro Elemento
Desenvolva uma função que consulte o primeiro elemento da fila sem removê-lo.

Caso a fila esteja vazia, a função deve informar a situação adequadamente.
*/
